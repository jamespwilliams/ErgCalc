...
@IBDesignable open class YokoTextField: TextFieldEffects {
    ...
    public let foregroundLayer = CALayer()
    public let borderThickness: CGFloat = 3
    public let placeholderInsets = CGPoint(x: 6, y: 6)
    public let textFieldInsets = CGPoint(x: 6, y: 6)
    ...
    override open func clearButtonRect(forBounds bounds: CGRect) -> CGRect {
        ...
        return originalRect.offsetBy(dx:0, dy:-8)
    }
    ...
    public func placeholderFontFromFont(_ font: UIFont) -> UIFont! {
        let smallerFont = UIFont(name: font.fontName, size: font.pointSize * placeholderFontScale)
        return smallerFont
    }
    
    public func rectForForeground(_ bounds: CGRect) -> CGRect {
    ...
    public func rectForBorder(_ bounds: CGRect, isFilled: Bool) -> CGRect {
    ...
    public func layoutPlaceholderInTextRect() {
    ...
    public func setAnchorPoint(_ anchorPoint:CGPoint, forView view:UIView) {
    ...
    public func colorWithBrightnessFactor(_ color: UIColor, factor: CGFloat) -> UIColor {
        var hue : CGFloat = 0
    ...
    public func rotationAndPerspectiveTransformForView(_ view: UIView) -> CATransform3D {
